...
public class TemplateDslTest {
  ...
  public void testCase00() {
    TemplateDsl dsl = dsl(new TestCase00());
    testBuffer(
        dsl,
        ""
    );
  ...
  public void testCase01() {
    TemplateDsl dsl = dsl(new TestCase01());
    testBuffer(
        dsl,
        "pt-BR"
    );
  ...
  public void testCase03() {
    TemplateDsl dsl = dsl(new TestCase03());
    testBuffer(
        dsl,
        ""
    );
  ...
  public void testCase06() {
    TemplateDsl dsl = dsl(new TestCase06());
    testBuffer(
        dsl,
        "pt-BRutf-8"
    );
  ...
  public void testCase09() {
    TemplateDsl dsl = dsl(new TestCase09());
    testBuffer(
        dsl,
        "html!doctype"
    );
  ...
  public void testCase10() {
    TemplateDsl dsl = dsl(new TestCase10());
    testBuffer(
        dsl,
        "utf-8"
    );
  ...
  public void testCase14() {
    TemplateDsl dsl = dsl(new TestCase14());
    testBuffer(
        dsl,
        "o7html"
    );
  ...
  public void testCase15() {
    TemplateDsl dsl = dsl(new TestCase15());
    testBuffer(
        dsl,
        "abc"
    );
  ...
  public void testCase16() {
    TemplateDsl dsl = dsl(new TestCase16());
    testBuffer(
        dsl,
        "elementattribute"
    );
  ...
  public void testCase18() {
    TemplateDsl dsl = dsl(new TestCase18());
    testBuffer(
        dsl,
        "idt1t2tc18"
    );
  ...
  public void testCase20() {
    TemplateDsl dsl = dsl(new TestCase20());
    testBuffer(
        dsl,
        "o7htmlis cool"
    );
  ...
  public void testCase21() {
    TemplateDsl dsl = dsl(new TestCase21());
    testBuffer(
        dsl,
        "firstsecond"
    );
  ...
  public void testCase26() {
    TemplateDsl dsl = dsl(new TestCase26());
    testBuffer(
        dsl,
        "f0f1f2"
    );
  ...
  private TemplateDsl dsl(AbstractTemplate tmpl) {
    TemplateDsl dsl = new TemplateDsl();
    tmpl.acceptTemplateDsl(dsl);
    return dsl;
  }

  private void testBuffer(TemplateDsl dsl, String expectedBuffer) {
    assertEquals(dsl.bufferToString(), expectedBuffer);
  }

  private void testCodes(TemplateDsl dsl, int... expectedCodes) {
  ...
  private void testProtos(TemplateDsl dsl, int... expectedProtos) {
