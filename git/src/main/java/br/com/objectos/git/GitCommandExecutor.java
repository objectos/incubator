...
public interface GitCommandExecutor extends GitExecutor {
   ...
   *         specified target directory
   */
  Computation<MaterializedEntry> materializeEntry(
   ...
   *         specified directory
   */
  Computation<Repository> openRepository(
      Directory directory);
   ...
   */
  Computation<Blob> readBlob(
      Repository repository, ObjectId id);
   ...
   */
  Computation<MaybeObjectId> resolve(
   ...
   */
  Computation<MaybeObjectId> updateRef(
   ...
   *         to a repository
   */
  Computation<ObjectId> writeCommit(
   ...
   *         repository
   */
  Computation<ObjectId> writeTree(
