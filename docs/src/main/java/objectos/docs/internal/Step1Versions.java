...
class Step1Versions extends Step0Config {
  ...
  private void release20230512() {
    version(
      name("0.6.5"),
      releaseDate(2023, 5, 12),
      status(Status.UNSUPPORTED),
