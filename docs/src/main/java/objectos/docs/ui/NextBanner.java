...
public final class NextBanner extends SiteFragment {
  ...
  final void set(DocsPage page) {
    Class<? extends DocsPage> c;
    c = page.getClass();

    String packageName;
    packageName = c.getPackageName();

    shouldRender = packageName.startsWith("objectos.docs.next");
  }
