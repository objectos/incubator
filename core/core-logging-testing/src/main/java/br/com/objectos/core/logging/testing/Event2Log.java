...
public final class Event2Log<T1, T2> extends Log {
   ...
   */
  public Event2Log(Note2<T1, T2> event, T1 value1, T2 value2) {
    super(event);
   ...
   */
  @Override
  public final <X1, X2> boolean isEvent2(Note2<X1, X2> event, X1 value1, X2 value2) {
    return Equals.of(
      this.event, event,
      this.value1, value1,
      this.value2, value2
