...
public class StackTraceElementsJava11Test {

  private final StackTraceElement element = new StackTraceElement(
      "loader", "module", "version", "test.Foo", "a", "Foo.java", 123);
  ...
  public void createStackTraceElement() {
    ...
    assertEquals(result.getClassLoaderName(), classLoaderName);

    assertEquals(result.getModuleName(), moduleName);

    assertEquals(result.getModuleVersion(), moduleVersion);
  ...
  public void getClassLoaderName() {
    assertEquals(StackTraceElements.getClassLoaderName(element), "loader");
  }

  @Test
  public void getModuleName() {
    assertEquals(StackTraceElements.getModuleName(element), "module");
  }

  @Test
  public void getModuleVersion() {
    assertEquals(StackTraceElements.getModuleVersion(element), "version");
  }
