...
public class ThrowablesTest {
  ...
  public void getStackTraceAsString() {
    try {
      ...
      assertTrue(
          lines[1].contains("br.com.objectos.throwables.Thrower.throwNoSuchElementException"));

      assertTrue(
          lines[2].contains("br.com.objectos.throwables.ThrowablesTest.getStackTraceAsString"));
