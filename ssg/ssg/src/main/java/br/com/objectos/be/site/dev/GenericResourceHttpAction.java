...
class GenericResourceHttpAction implements HttpAction, Response {

  private final GenericResource resource;

  GenericResourceHttpAction(GenericResource resource) {
  ...
  public final boolean equals(Object obj) {
    ...
    if (!(obj instanceof GenericResourceHttpAction)) {
      return false;
    }
    GenericResourceHttpAction that = (GenericResourceHttpAction) obj;
    return resource.type().equals(that.resource.type())
        && resource.filename().equals(that.resource.filename());
  }
  ...
  public final int hashCode() {
    return Objects.hash(resource.type(), resource.filename());
  }
  ...
  public final void writeTo(ResponseWriter writer) throws HttpException {
    try {
      ...
      writer.contentType(resource.type());
