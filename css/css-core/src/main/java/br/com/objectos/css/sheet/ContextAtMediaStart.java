...
class ContextAtMediaStart<E extends Exception> extends Context<E> {

  private static final ContextAtMediaStart<Exception> INSTANCE = new ContextAtMediaStart<>();

  private ContextAtMediaStart() {}
