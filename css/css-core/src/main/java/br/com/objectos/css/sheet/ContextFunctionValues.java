...
final class ContextFunctionValues<E extends Exception> extends ContextVisitValue<E> {

  private static final ContextFunctionValues<Exception> INSTANCE
      = new ContextFunctionValues<>();

  private ContextFunctionValues() {}
