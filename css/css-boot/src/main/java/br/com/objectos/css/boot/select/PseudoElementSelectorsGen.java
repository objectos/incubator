...
public class PseudoElementSelectorsGen extends AbstractSelectorStep {
  ...
  public static FieldCode styleSheetField(String name) {
    return SelectNames.styleSheetField(
        SelectNames.PseudoElementSelector, toFieldName(name)
    );
  }
  ...
  final NamedClass getGeneratedName() {
    return SelectNames.PseudoElementSelectors;
  }

  @Override
  final NamedClass getImplName() {
    return SelectNames.PseudoElementSelector;
  }
