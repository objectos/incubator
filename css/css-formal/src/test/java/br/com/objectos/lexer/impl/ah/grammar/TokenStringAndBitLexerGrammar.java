...
public class TokenStringAndBitLexerGrammar extends AbstractLexerGrammar<IsToken, IsBrick> {

  private static final TokenStringAndBitLexerGrammar INSTANCE = new TokenStringAndBitLexerGrammar();

  private TokenStringAndBitLexerGrammar() {
  }

  public static TokenStringAndBitLexerGrammar get() {
    return INSTANCE;
  }
  ...
  protected final void definition() {
    ...
    defineToken(Bit.class)
        .asEnum()
        .andCreateWith(Bit::stringValue);
  }
