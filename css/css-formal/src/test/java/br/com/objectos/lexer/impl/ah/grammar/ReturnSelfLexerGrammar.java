...
public class ReturnSelfLexerGrammar extends AbstractLexerGrammar<IsToken, IsBrick> {

  private static final ReturnSelfLexerGrammar INSTANCE = new ReturnSelfLexerGrammar();

  private ReturnSelfLexerGrammar() {
  }

  public static ReturnSelfLexerGrammar get() {
    return INSTANCE;
  }
