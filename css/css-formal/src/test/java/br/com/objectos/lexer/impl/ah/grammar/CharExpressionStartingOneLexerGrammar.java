...
public class CharExpressionStartingOneLexerGrammar extends AbstractLexerGrammar<IsToken, IsBrick> {

  private static final CharExpressionStartingOneLexerGrammar INSTANCE = new CharExpressionStartingOneLexerGrammar();

  private CharExpressionStartingOneLexerGrammar() {
  }

  public static CharExpressionStartingOneLexerGrammar get() {
    return INSTANCE;
  }
