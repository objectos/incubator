...
public class StartingBrickLexerGrammar extends AbstractLexerGrammar<IsToken, IsBrick> {

  private static final StartingBrickLexerGrammar INSTANCE = new StartingBrickLexerGrammar();

  private StartingBrickLexerGrammar() {
  }

  public static StartingBrickLexerGrammar get() {
    return INSTANCE;
  }
