...
public class AnswerOnlyLexerGrammar extends AbstractLexerGrammar<IsToken, IsBrick> {

  private static final AnswerOnlyLexerGrammar INSTANCE = new AnswerOnlyLexerGrammar();

  private AnswerOnlyLexerGrammar() {
  }

  public static AnswerOnlyLexerGrammar get() {
    return INSTANCE;
  }
