...
public class Grammar03 extends AbstractParserGrammar<IsComplex, IsPrimary> {

  @Override
  protected void definition() {
    // <HasDigits> -> Digits+
    define(HasDigits.class)
        .addToken(Digit.class).oneOrMore()
        .andCreateWith(HasDigits::ofIterable);

    // <HasLetters> -> Letter+
    define(HasLetters.class)
        .addToken(Letter.class).oneOrMore()
