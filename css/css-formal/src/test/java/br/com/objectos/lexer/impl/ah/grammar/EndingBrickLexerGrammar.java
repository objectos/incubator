...
public class EndingBrickLexerGrammar extends AbstractLexerGrammar<IsToken, IsBrick> {

  private static final EndingBrickLexerGrammar INSTANCE = new EndingBrickLexerGrammar();

  private EndingBrickLexerGrammar() {
  }

  public static EndingBrickLexerGrammar get() {
    return INSTANCE;
  }
