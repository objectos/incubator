...
public class CharExpressionProtoNextLexerGrammar extends AbstractLexerGrammar<IsToken, IsBrick> {

  private static final CharExpressionProtoNextLexerGrammar INSTANCE = new CharExpressionProtoNextLexerGrammar();

  private CharExpressionProtoNextLexerGrammar() {
  }

  public static CharExpressionProtoNextLexerGrammar get() {
    return INSTANCE;
  }
