...
public class AnswerWsLexerGrammar extends AbstractLexerGrammar<IsToken, IsBrick> {

  private static final AnswerWsLexerGrammar INSTANCE = new AnswerWsLexerGrammar();

  private AnswerWsLexerGrammar() {
  }

  public static AnswerWsLexerGrammar get() {
    return INSTANCE;
  }
