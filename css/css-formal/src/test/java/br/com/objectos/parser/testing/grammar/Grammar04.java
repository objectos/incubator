...
public class Grammar04 extends AbstractParserGrammar<IsComplex, IsPrimary> {

  @Override
  protected final void definition() {
    // S -> cAd
    define(ComplexTrio.class)
        .addToken(Letter.C)
        .addRule(ComplexDuo.class)
        .addToken(Letter.D)
        .andCreateWith(ComplexTrio::new);

    // A -> ab
    define(ComplexDuo.class)
        .addToken(Letter.A)
        .addToken(Letter.B)
        .andCreateWith(ComplexDuo::new);

    // A -> a
    define(ComplexDuo.class)
        .addToken(Letter.A)
        .andCreateWith(ComplexDuo::withOne);
  }
