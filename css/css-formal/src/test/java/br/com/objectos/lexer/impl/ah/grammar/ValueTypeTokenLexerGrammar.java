...
public class ValueTypeTokenLexerGrammar extends AbstractLexerGrammar<IsToken, IsBrick> {

  private static final ValueTypeTokenLexerGrammar INSTANCE = new ValueTypeTokenLexerGrammar();

  private ValueTypeTokenLexerGrammar() {
  }

  public static ValueTypeTokenLexerGrammar get() {
    return INSTANCE;
  }
  ...
  protected final void definition() {
    ...
    defineBrick(AngBracket.class)
        .asEnum()
        .andCreateWith(AngBracket::stringValue);
  }
