...
public class SelectorCombinatorLexerGrammar extends AbstractLexerGrammar<IsToken, IsBrick> {

  private static final SelectorCombinatorLexerGrammar INSTANCE = new SelectorCombinatorLexerGrammar();

  private SelectorCombinatorLexerGrammar() {
  }

  public static SelectorCombinatorLexerGrammar get() {
    return INSTANCE;
  }

  @Override
  protected final void definition() {
    defineToken(Letter.A)
