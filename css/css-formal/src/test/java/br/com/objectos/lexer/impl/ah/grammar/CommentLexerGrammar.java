...
public class CommentLexerGrammar extends AbstractLexerGrammar<IsToken, IsBrick> {

  private static final CommentLexerGrammar INSTANCE = new CommentLexerGrammar();

  private CommentLexerGrammar() {
  }

  public static CommentLexerGrammar get() {
    return INSTANCE;
  }

  @Override
  protected final void definition() {
    defineToken(Comment.class)
        .addString("/*")
        .addChar(CharExpression.any()).zeroOrMoreNonGreedy()
        .addString("*/")
        .andCreateWith(Comment::get);
