...
public class StartingBrickAndAnswerLexerGrammar extends AbstractLexerGrammar<IsToken, IsBrick> {

  private static final StartingBrickAndAnswerLexerGrammar INSTANCE = new StartingBrickAndAnswerLexerGrammar();

  private StartingBrickAndAnswerLexerGrammar() {
  }

  public static StartingBrickAndAnswerLexerGrammar get() {
    return INSTANCE;
  }
