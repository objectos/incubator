...
class PushLexerAction implements SpecAction {

  private final SpecAction delegate;
  private final Spec spec;

  PushLexerAction(SpecAction delegate, Spec spec) {
  ...
  public final StateWriter toString(StateWriter w) {
    return delegate.toString(w).begin().write("push()");
  }
