...
class StringConditionState extends AbstractConditionState {

  private final String condition;

  StringConditionState(String condition, State failState, State matchState) {
  ...
  public final State next(StateSubject subject) {
    ...
    if (lexeme.matchesString(condition)) {
      lexeme.consumeString(condition);
      return matchState;
    } else {
      return failState;
    }
