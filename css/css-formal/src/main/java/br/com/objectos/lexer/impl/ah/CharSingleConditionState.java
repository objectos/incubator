...
class CharSingleConditionState extends AbstractConditionState {

  private final char value;

  CharSingleConditionState(char value, State failState, State matchState) {
  ...
  public final State next(StateSubject subject) {
    ...
    if (lexeme.matchesChar(value)) {
      lexeme.consumeChar(value);
      return matchState;
    } else {
      return failState;
    }
