...
final class StringParamSlug extends Slug {

  static final StringParamSlug INSTANCE = new StringParamSlug();

  private StringParamSlug() {}

  @Override
  public final boolean matches(RouteParser parser, RequestedPart requested) {
    return requested.matchesStringParamSlug(parser);
  }
