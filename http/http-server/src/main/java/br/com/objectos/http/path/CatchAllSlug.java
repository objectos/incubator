...
final class CatchAllSlug extends Slug {

  static final CatchAllSlug INSTANCE = new CatchAllSlug();

  private CatchAllSlug() {}

  @Override
  public final boolean matches(RouteParser parser, RequestedPart requested) {
    return requested.matchesCatchAllSlug(parser);
  }
