...
final class IntParamSlug extends Slug {

  static final IntParamSlug INSTANCE = new IntParamSlug();

  private IntParamSlug() {}

  @Override
  public final boolean matches(RouteParser parser, RequestedPart requested) {
    return requested.matchesIntParamSlug(parser);
  }
